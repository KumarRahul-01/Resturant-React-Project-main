...
export default function Navbar() {
  ...
  return (
    <header
      ref={headRef}
      className="fixed w-full top-0 left-0 z-50 bg-white pt-[13px] transition-all duration-200"
    >
      <div className="contain-content mx-auto flex items-center justify-around px-6">
        <div className="logo w-[17%]">
          <Link to="/" className="flex items-center">
            <span className="logoname text-[30px] ml-2 font-bold relative after:content-[''] after:absolute after:w-[6px] after:h-[6px] after:top-[27px] after:bg-red-600 after:rounded-full">
              Mealify
            </span>
          </Link>
        </div>
