      ...
      <div className="container bg-white  overflow-hidden md:px-5 lg:px-20 px-0">
        <div className="title text-center text-[20px] py-8">
          ...
          <h3 className="text-[42px] font-semibold">
            Our <span className="text-red-600">Proffesional</span> Chefs
          </h3>
        </div>
          ...
          <Slide direction="left" triggerOnce duration={2000}>
            <div className="card bg-white  rounded-xl overflow-hidden shadow-lg pb-3 hover:scale-[1.05] transition-transform">
              ...
              <div className="cardcontent text-center mt-3">
                ...
                <p className="text-[12px] text-gray-500 mt-2 md:text-[14px] lg:text-[14px]">
                  Velit aut quia fugit et et. Dolorum ea voluptate vel<br></br>{" "}
                  tempore tenetur ipsa quae aut. Ipsum exercitationem<br></br>
          ...
          <Slide direction="down" triggerOnce duration={2000}>
            <div className="card  bg-white rounded-xl overflow-hidden shadow-lg pb-3 hover:scale-[1.05] transition-transform">
              ...
              <div className="cardcontent text-center mt-3">
                ...
                <p className="text-[12px] text-gray-500 mt-2 md:text-[14px] lg:text-[14px]">
                  Quo esse repellendus quia id. Est eum et accusantium<br></br>{" "}
          ...
          <Slide direction="right" triggerOnce duration={2000}>
            <div className="card  bg-white rounded-xl overflow-hidden shadow-lg pb-3 hover:scale-[1.05] transition-transform">
              ...
              <div className="cardcontent text-center mt-3">
                ...
                <p className="text-[12px] text-gray-500 mt-2 md:text-[14px] lg:text-[14px]">
                  Vero omnis enim consequatur. Voluptas consectetur<br></br>
                  unde qui molestiae deserunt. Voluptates enim aut<br></br>{" "}
